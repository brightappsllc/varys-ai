            ...
            messages.map(msg => {
                ...
                return (React.createElement(React.Fragment, { key: msg.id },
                    ...
                    msg.operationId && (() => {
                        ...
                        if (!(op === null || op === void 0 ? void 0 : op.resolved))
                            return null;
                        return (React.createElement(DiffView, { operationId: op.operationId, diffs: op.diffs, onAccept: handleAccept, onUndo: handleUndo, resolved: op.resolved }));
                    })()));
            }),
