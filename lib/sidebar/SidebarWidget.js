...
const ModelsPanel = ({ apiClient, onClose, onSaved, notebookPath = '', section = 'model-routing', subSection = null, onProviderStatusChange, }) => {
    ...
    return (React.createElement("div", { className: "ds-settings-panel" },
        React.createElement("div", { className: "ds-settings-tab-content" }, section === 'model-routing' ? (React.createElement(React.Fragment, null,
            ...
            React.createElement("p", { className: "ds-settings-bg-task-note" },
                React.createElement("strong", null, "Background Task Model"),
                " powers background work: long-term memory inference, preference extraction, and LLM summarization of large markdown cells (>2 000 chars). Without a configured Background model, large markdown cells are ",
            ...
            currentGroup.fields.map(field => {
                ...
                return (React.createElement(React.Fragment, { key: field.key },
                    ...
                    React.createElement("div", { className: "ds-settings-row" },
                        ...
                        React.createElement("input", { className: `ds-settings-input${isDisabled ? ' ds-settings-input--disabled' : ''}`, type: field.type === 'password' && masked[field.key] ? 'password' : 'text', value: (_d = values[field.key]) !== null && _d !== void 0 ? _d : '', onChange: e => handleChange(field.key, e.target.value), placeholder: field.type === 'password' ? '(unchanged)' : ((_e = field.placeholder) !== null && _e !== void 0 ? _e : ''), autoComplete: "off", disabled: isDisabled }))));
            }),
