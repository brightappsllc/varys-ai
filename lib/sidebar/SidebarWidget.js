        ...
        const loadForNotebook = async (newPath) => {
            ...
            try {
                ...
                if (chatFile.needsIdStamp) {
                    (_c = notebookTracker.currentWidget) === null || _c === void 0 ? void 0 : _c.context.save().catch(err => {
                        console.debug('[Varys] silent id-stamp save failed:', err);
                    });
                }
                if (chatFile.threads.length > 0) {
                    const lastId = (_d = chatFile.lastThreadId) !== null && _d !== void 0 ? _d : chatFile.threads[0].id;
    ...
    return (React.createElement("div", { className: `ds-assistant-sidebar ds-chat-${chatTheme}` },
        React.createElement("div", { className: "ds-assistant-header" },
            React.createElement("span", { className: "ds-assistant-title" },
                ...
                "Varys",
                ' ',
                React.createElement("span", { className: "ds-varys-version ds-varys-version--clickable", onClick: openChangelog, title: "View changelog" }, "v0.8.5"),
