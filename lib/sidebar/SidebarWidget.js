    ...
    return (React.createElement("div", { className: "ds-settings-panel" },
        React.createElement("div", { className: "ds-settings-tab-content" }, section === 'model-routing' ? (React.createElement(React.Fragment, null,
            ...
            React.createElement("p", { className: "ds-settings-bg-task-note" },
                React.createElement("strong", null, "Background Task"),
                " powers background work: long-term memory inference, preference extraction, and LLM prose summarization of large markdown cells (>2 000 chars). Without a configured Background Model, large markdown cells are ",
