    ...
    return (React.createElement("div", { className: `ds-assistant-sidebar ds-chat-${chatTheme}` },
        React.createElement("div", { className: "ds-assistant-header" },
            React.createElement("span", { className: "ds-assistant-title" },
                ...
                "Varys",
                ' ',
                React.createElement("span", { className: "ds-varys-version" }, "v0.7.0"),
                updateVersion && (React.createElement("a", { className: "ds-varys-update-pill", href: updateUrl || '#', target: "_blank", rel: "noreferrer", title: `v${updateVersion} is available — click to view release notes` },
                    "\u2191 v",
                    updateVersion))),
