...
const ModelsPanel = ({ apiClient, onClose, onSaved, notebookPath = '', section = 'model-routing', subSection = null, onProviderStatusChange, }) => {
    ...
    return (React.createElement("div", { className: "ds-settings-panel" },
        React.createElement("div", { className: "ds-settings-tab-content" }, section === 'model-routing' ? (React.createElement(React.Fragment, null,
                ...
                if (field.type === 'toggle') {
                    ...
                    return (React.createElement(React.Fragment, { key: field.key },
                        ...
                        React.createElement("div", { className: "ds-settings-routing-toggle-row" },
                            React.createElement("div", { className: `ds-settings-toggle${isOn ? ' ds-settings-toggle--on' : ''}`, onClick: () => handleChange(field.key, isOn ? 'false' : 'true'), role: "switch", "aria-checked": isOn },
                                React.createElement("div", { className: "ds-settings-toggle-knob" })),
            ...
            React.createElement("div", { className: "ds-settings-bg-task-bubble" },
                React.createElement("div", { className: "ds-settings-bg-task-bubble-title" }, "Background Task Model"),
                React.createElement("p", { className: "ds-settings-bg-task-bubble-body" }, "Powers background work independently of your chat model: long-term memory inference, preference extraction, and LLM summarization of large markdown cells (>2 000 chars)."),
                React.createElement("p", { className: "ds-settings-bg-task-bubble-body" },
