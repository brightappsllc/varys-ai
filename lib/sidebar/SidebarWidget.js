                ...
                return (React.createElement(React.Fragment, { key: msg.id },
                    ...
                    msg.role === 'assistant' && msg.operationId && (() => {
                        ...
                        const diffsToShow = (msg.diffs && msg.diffs.length > 0)
                            ? msg.diffs
                            : op === null || op === void 0 ? void 0 : op.diffs;
                        if (!diffsToShow || !diffsToShow.length)
                            return null;
                        const resolvedStatus = (_a = msg.diffResolved) !== null && _a !== void 0 ? _a : op === null || op === void 0 ? void 0 : op.resolved;
                        return (React.createElement(DiffView, { key: msg.operationId, operationId: msg.operationId, description: op === null || op === void 0 ? void 0 : op.description, diffs: diffsToShow, onAccept: handleAccept, onUndo: handleUndo, resolved: resolvedStatus }));
                    })()));
            }),
