...
const ThreadBar = ({ threads, currentId, notebookName, onSwitch, onNew, onRename, onDuplicate, onDelete, rightSlot, }) => {
    ...
    return (React.createElement("div", { className: "ds-thread-bar", ref: popupRef },
        ...
        rightSlot && (React.createElement("div", { className: "ds-thread-bar-right" }, rightSlot))));
};
// ---------------------------------------------------------------------------
...
const DSAssistantChat = ({ apiClient, notebookReader, cellEditor, notebookTracker, openFile, reloadFile, }) => {
    ...
    useEffect(() => {
        const handler = (issues) => setReproIssueCount(issues.length);
    ...
    return (React.createElement("div", { className: `ds-assistant-sidebar ds-chat-${chatTheme}` },
        ...
        React.createElement(ThreadBar, { threads: threads, currentId: currentThreadId, notebookName: currentNotebookPath
                ...
                : '', onSwitch: handleSwitchThread, onNew: handleNewThread, onRename: (id, name) => void handleRenameThread(id, name), onDuplicate: handleDuplicateThread, onDelete: (id) => void handleDeleteThread(id), rightSlot: currentNotebookPath.endsWith('.ipynb') ? (React.createElement("span", { className: "ds-repro-shield-wrap" },
                ...
                reproIssueCount > 0 && (React.createElement("span", { className: "ds-repro-dot", "aria-label": `${reproIssueCount} reproducibility issue${reproIssueCount === 1 ? '' : 's'}` }, reproIssueCount < 10 ? reproIssueCount : '9+')))) : undefined }),
