        ...
        try {
            ...
            const markHadCellOps = (opId, opDiffs) => {
                setMessages(prev => prev.map(m => m.id === streamMsgId
                    ? Object.assign(Object.assign(Object.assign({}, m), { hadCellOps: true, operationId: opId }), (opDiffs ? { diffs: opDiffs } : {})) : m));
            };
        ...
        React.createElement("div", { ref: messagesContainerRef, className: "ds-assistant-messages", onClick: (e) => {
            ...
            messages.map(msg => {
                ...
                return (React.createElement(React.Fragment, { key: msg.id },
                    ...
                    msg.diffs && msg.diffs.length > 0 && (React.createElement(DiffView, { operationId: msg.operationId, diffs: msg.diffs, onAccept: handleAccept, onUndo: handleUndo, resolved: msg.diffResolved }))));
            }),
