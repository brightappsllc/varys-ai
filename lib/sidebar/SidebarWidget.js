    ...
    return (React.createElement("div", { className: `ds-assistant-sidebar ds-chat-${chatTheme}` },
        ...
        React.createElement(ThreadBar, { threads: threads, currentId: currentThreadId, notebookName: currentNotebookPath
                ...
                React.createElement("span", { className: "ds-repro-shield-wrap" },
                    ...
                    reproIssueCount > 0 && (React.createElement("span", { className: "ds-repro-dot", "aria-label": `${reproIssueCount} reproducibility issue${reproIssueCount === 1 ? '' : 's'}` }, reproIssueCount < 10 ? reproIssueCount : '9+'))),
                React.createElement("button", { className: "ds-graph-open-btn", onClick: () => { var _a; return (_a = props.onOpenGraph) === null || _a === void 0 ? void 0 : _a.call(props); }, title: "Notebook dependency graph", "data-tip": "Dependency Graph", "data-tip-below": true }, "\u2B21"))) : undefined }),
