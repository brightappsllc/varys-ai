...
const DSAssistantChat = (props) => {
    ...
    const [limitToFocal, setLimitToFocal] = useState(() => {
        try {
    ...
    const limitToFocalRef = useRef(limitToFocal);
    ...
    priorMessages) => {
        ...
        try {
            ...
            let thoughtsAccum = '';
            const response = await apiClient.executeTaskStreaming(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ message, notebookContext: context, chatHistory, variables: resolvedVariables }, (slashCommand ? { command: slashCommand } : {})), { cellMode: (notebookAware || !!currentFilePathRef.current) ? cellMode : 'chat' }), (limitToFocalRef.current ? { limitToFocal: true } : {})), (reasoningModeRef.current !== 'off' ? { reasoningMode: reasoningModeRef.current } : {})), (imageModeRef.current ? { imageMode: imageModeRef.current } : {})), 
        ...
        React.createElement("div", { className: "ds-assistant-input-area" },
            ...
            React.createElement("div", { className: "ds-input-frame" },
                ...
                React.createElement("div", { className: "ds-assistant-input-bottom" },
                    ...
                    (notebookAware || !!currentFilePath) && cellMode === 'agent' && (React.createElement("button", { type: "button", className: `ds-focus-toggle${limitToFocal ? ' active' : ''}`, title: limitToFocal
                            ? 'Context limited to active cell and above. Click to send the full notebook.'
                            : 'Send the full notebook as context. Click to limit context to the active cell and above.', onClick: () => {
