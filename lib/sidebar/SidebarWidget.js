...
const ThreadBar = ({ threads, currentId, notebookName, onSwitch, onNew, onRename, onDuplicate, onDelete, rightSlot, }) => {
    const [open, setOpen] = useState(false);
...
const DSAssistantChat = (props) => {
    ...
    const [changelogMode, setChangelogMode] = useState('whats-new');
                ...
                void (async () => {
                    for (const step of op.steps) {
                        if (step.autoExecute === true &&
                            ...
                            try {
                                await cellEditor.executeCell(step.cellIndex);
                            }
                            catch ( /* ignore */_a) { /* ignore */ }
                        }
                    }
    ...
    if (showChangelog) {
        ...
        return (React.createElement("div", { className: `ds-assistant-sidebar ds-chat-${chatTheme}` },
            ...
            React.createElement("div", { className: "ds-changelog-panel" },
                React.createElement("div", { className: "ds-changelog-tabs" },
                    React.createElement("button", { className: `ds-changelog-tab${isWhatsNew ? ' ds-changelog-tab--active' : ''}`, onClick: openWhatsNew }, updateVersion ? `↑ v${updateVersion}` : "What's New"),
                    React.createElement("button", { className: `ds-changelog-tab${!isWhatsNew ? ' ds-changelog-tab--active' : ''}`, onClick: openHistory }, "Full History")),
                React.createElement("div", { className: "ds-changelog-body" }, changelogLoading ? (React.createElement("div", { className: "ds-changelog-loading" }, "Loading\u2026")) : changelogBody ? (React.createElement(React.Fragment, null,
                    React.createElement("div", { className: "ds-changelog-content ds-message-content", dangerouslySetInnerHTML: { __html: renderMarkdown(changelogBody) } }),
                    isWhatsNew && updateUrl && (React.createElement("div", { className: "ds-changelog-footer" },
                        React.createElement("a", { href: updateUrl, target: "_blank", rel: "noreferrer", className: "ds-changelog-github-link" }, "View on GitHub \u2197"),
                        React.createElement("div", { className: "ds-changelog-update-cmd" },
                            React.createElement("code", null, "pip install --upgrade varys")))))) : (React.createElement("div", { className: "ds-changelog-empty" }, isWhatsNew
    ...
    return (React.createElement("div", { className: `ds-assistant-sidebar ds-chat-${chatTheme}` },
        React.createElement("div", { className: "ds-assistant-header" },
            React.createElement("span", { className: "ds-assistant-title" },
                ...
                "Varys",
                ' ',
                React.createElement("span", { className: "ds-varys-version ds-varys-version--clickable", onClick: openHistory, title: "View changelog" }, "v0.7.0"),
                updateVersion && (React.createElement("button", { className: "ds-varys-update-pill", onClick: openWhatsNew, title: `v${updateVersion} is available — click to see what's new` },
                    "\u2191 v",
                    updateVersion))),
                            ...
                            (() => {
                                ...
                                return (React.createElement("div", { className: `ds-msg-collapsible-wrap${collapsed ? ' ds-msg-collapsed' : ''}` },
                                    ...
                                    msg.role === 'user' ? (React.createElement("div", { className: `ds-assistant-message-content ds-markdown${!isLoading ? ' ds-user-editable' : ''}`, onClick: !isLoading ? () => {
                                        ...
                                        } })) : (React.createElement("div", { className: "ds-assistant-message-content ds-markdown", dangerouslySetInnerHTML: { __html: renderMarkdown(((_e = msg.displayContent) !== null && _e !== void 0 ? _e : msg.content).replace(/[\r\n\s]+$/, '')) } })),
