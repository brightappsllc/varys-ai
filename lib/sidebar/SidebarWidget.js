...
const ThreadBar = ({ threads, currentId, notebookName: _notebookName, onSwitch, onNew, onRename, onDuplicate, onDelete, rightSlot, }) => {
    ...
    return (React.createElement("div", { className: "ds-thread-bar" },
        React.createElement("div", { className: "ds-thread-pills" }, threads.map(t => (React.createElement("div", { key: t.id, className: `ds-thread-pill${t.id === currentId ? ' ds-thread-pill--active' : ''}${editingId === t.id ? ' ds-thread-pill--editing' : ''}` }, editingId === t.id ? (
        /* Inline rename input */
            ...
            React.createElement("div", { className: "ds-input-frame" },
                React.createElement("div", { className: "ds-input-body" },
                    React.createElement("div", { className: "ds-nb-ctx-row" },
                        React.createElement("span", { className: "ds-nb-ctx-label", title: "Context" }, "\uD83D\uDCCE"),
                ...
                React.createElement("div", { className: "ds-assistant-input-bottom" },
                    ...
                    isLoading ? (React.createElement("button", { className: "ds-assistant-send-btn ds-send-stop", onClick: handleStop, title: "Stop generation", "aria-label": "Stop generation" },
                        React.createElement("svg", { viewBox: "0 0 24 24", width: "10", height: "10", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
                            ...
                            React.createElement("rect", { x: "8", y: "8", width: "8", height: "8", rx: "1", fill: "currentColor" })))) : input.trim() ? (React.createElement("button", { className: "ds-assistant-send-btn ds-send-arrow", onClick: () => void handleSend(), title: "Send message (Enter)", "aria-label": "Send message" },
                        React.createElement("svg", { viewBox: "0 0 24 24", width: "10", height: "10", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
