    ...
    return (React.createElement("div", { className: `ds-diff-view${resolved ? ` ds-diff-view--resolved ${resolvedMod}` : ''}` },
        React.createElement("div", { className: "ds-diff-header" },
            ...
            React.createElement("button", { className: "ds-diff-expand-btn", onClick: () => setExpanded(e => !e), title: expanded ? 'Collapse diff' : 'Expand diff' }, expanded ? '⌃ Hide' : '⌄ Show')) : (React.createElement(React.Fragment, null,
                requiresApproval && (React.createElement("button", { className: "ds-assistant-btn ds-assistant-btn-accept", onClick: () => onAccept(operationId), title: "Accept changes and run cells" }, "\u2713 Apply & Run")),
                React.createElement("button", { className: "ds-assistant-btn ds-assistant-btn-undo", onClick: () => onUndo(operationId), title: "Reject changes and undo" }, "\u2715 Undo"))))),
        !resolved && (React.createElement("div", { className: "ds-diff-hint" }, isReorder
            ...
            : requiresApproval
                ? React.createElement(React.Fragment, null,
                    "Review the changes below, then use ",
                    React.createElement("strong", null, "\u2713 Apply & Run"),
                    " to execute or ",
                    React.createElement("strong", null, "\u2715 Undo"),
                    " to revert.")
                : React.createElement(React.Fragment, null,
