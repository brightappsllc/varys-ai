...
export const DiffView = ({ operationId, description, diffs, onAccept, onUndo, resolved, }) => {
    ...
    return (React.createElement("div", { className: `ds-diff-view${resolved ? ` ds-diff-view--resolved ${resolvedMod}` : ''}` },
        React.createElement("div", { className: "ds-diff-header" },
            ...
            React.createElement("div", { className: "ds-diff-header-actions" }, !resolved && (React.createElement(React.Fragment, null,
        ...
        !resolved && expanded && (React.createElement("div", { className: "ds-diff-cells" }, diffs.map((d, i) => (React.createElement(CellDiffSection, { key: i, info: d, defaultOpen: defaultOpen, onCellDecisions: () => { } })))))));
};
