...
export const FileChangeCard = ({ event, operationId, apiBaseUrl, xsrfToken, onResolved, }) => {
    ...
    const diffStats = useMemo(() => {
        const orig = effectiveOriginal !== null && effectiveOriginal !== void 0 ? effectiveOriginal : '';
        const next = effectiveNew !== null && effectiveNew !== void 0 ? effectiveNew : '';
        return getDiffStats(computeLineDiff(orig, next));
    }, [effectiveOriginal, effectiveNew]);
    const statsLabel = event.change_type === 'created' ? `+${diffStats.insertions}`
    ...
    return (React.createElement("div", { className: `ds-file-change-card ds-file-change-card--${state}` },
        React.createElement("div", { className: "ds-file-change-card__header", onClick: () => setExpanded(e => !e), style: { cursor: 'pointer' } },
            ...
            React.createElement("span", { className: "ds-file-change-card__fname", title: event.file_path }, fname),
            statsLabel && (React.createElement("span", { className: "ds-file-change-card__stats" }, statsLabel)),
        ...
        expanded && (React.createElement("div", { className: "ds-file-change-card__body" },
            ...
            showDiffBody && (React.createElement(React.Fragment, null,
                ...
                React.createElement("div", { className: "ds-file-change-card__actions" },
                    React.createElement("button", { className: "ds-assistant-btn ds-assistant-btn-accept", onClick: handleAccept }, "\u2713 Apply"),
                    React.createElement("button", { className: "ds-assistant-btn ds-assistant-btn-undo", onClick: handleReject }, "\u2715 Undo")))),
