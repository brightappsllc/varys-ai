...
const Legend = () => (React.createElement("div", { className: "ds-graph-legend" },
    React.createElement("span", { className: "ds-graph-legend-item" },
        React.createElement("span", { className: "ds-graph-legend-line ds-graph-legend-normal" }),
        " Normal flow"),
    React.createElement("span", { className: "ds-graph-legend-item" },
        React.createElement("span", { className: "ds-graph-legend-line ds-graph-legend-skip" }),
        " Skip-link"),
    React.createElement("span", { className: "ds-graph-legend-item" },
        React.createElement("span", { className: "ds-graph-legend-line ds-graph-legend-order" }),
        " Out-of-order"),
    React.createElement("span", { className: "ds-graph-legend-item" },
        React.createElement("span", { className: "ds-graph-legend-dot ds-graph-legend-dead" }),
        "Dead symbol"),
    React.createElement("span", { className: "ds-graph-legend-item" },
        React.createElement("span", { className: "ds-graph-legend-dashed" }),
        "Unexecuted")));
    ...
    return (React.createElement("div", { className: "ds-graph-panel" },
        React.createElement("div", { className: "ds-graph-header" },
            React.createElement("div", { className: "ds-graph-header-left" },
                React.createElement("span", { className: "ds-graph-icon" }, "\u2B21"),
