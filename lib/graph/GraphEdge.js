...
export const GraphEdge = ({ edge, layout, nodeLayouts, zoom, dimmed }) => {
    ...
    return (React.createElement("g", { className: "ds-graph-edge", style: { opacity: dimmed ? 0.3 : 1, transition: 'opacity 0.15s' } },
        React.createElement("path", { d: pathData, fill: "none", stroke: color, strokeWidth: edge.anomaly ? 2 : 1.5, markerEnd: `url(#${arrowId})`, strokeDasharray: edge.anomaly === 'OUT_OF_ORDER' ? '5,3' : undefined }),
